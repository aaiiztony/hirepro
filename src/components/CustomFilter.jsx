    ...
    <div className="sm:mt-0 mt-5">
      <Combobox value={selected} onChange={setSelected}>
        <div className="relative">
          <Combobox.Input
            className="w-full h-[45px] rounded-lg sm:ml-[-10%] ml-0 pl-4 shadow"
        ...
        >
          <Combobox.Options className="absolute mt-1 max-h-60 sm:w-[200px] w-[80%] sm:ml-[-1.5%] ml-0 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-20">
