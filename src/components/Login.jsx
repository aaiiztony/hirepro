...
const Login = () => {
  ...
  return (
    ...
    <Lottie animationData={LoginAnimation} className="sm:h-[400px] w-full"/>
    <div className="Login__container">
    <h1 className="font-extrabold sm:text-4xl text-xl font-dsans mt-20 mb-3 ml-2"> Already have an account?<br />
    </h1><span className="font-semibold text-sm font-dsans mb-3 ml-2">Go to your dashboard👨‍🏫</span>
